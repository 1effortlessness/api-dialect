...
class Arg {
  constructor (name, required = false, type, dft) {
    this.name = name
  ...
  static factory (model, method = 'post') {
    ...
    Object.keys(attributes).forEach(k => {
      ...
      if (v.hasOwnProperty('allowNull') && !v.allowNull && !v.hasOwnProperty('defaultValue') && method === 'post') {
        arg.setRequired()
      }
      ...
      if (v.type.key === 'INTEGER' || v.type.key === 'BIGINT') {
        arg.type = 'integer'
      }
